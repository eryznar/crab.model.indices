...
```{r nsrkc-pred-50kn, fig.align = "center", fig.cap = "Heat map of Norton Sound red king crab predicted abundance generated using the model with 50 knots."}

knitr::include_graphics(here::here("NSRKC/plots/pred_heat_iid_30kn.png"))
```

```{r nsrkc-pred-90kn, fig.align = "center", fig.cap = "Heat map of Norton Sound red blue king crab predicted abundance generated using the model with 90 knots."}

knitr::include_graphics(here::here("NSRKC/plots/pred_heat_iid_50kn.png"))
```

```{r nsrkc-pred-120kn, fig.align = "center", fig.cap = "Heat map of Norton Sound red blue king crab predicted abundance generated using the model with 120 knots."}
