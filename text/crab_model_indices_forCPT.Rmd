...
The DHARMa residuals diagnostic plot showed evidence of quantile deviations for the NSRKC model (Figure \@ref(fig:nsrkc-qq-rw-tw-30kn)), but there was no evidence of over- or underdispersion, outliers, or zero inflation.  
...
Heat maps of predicted NSRKC abundance for the three models with the best out-of-sample predictive skill are show in figures \@ref(fig:nsrkc-pred-30kn) - \@ref(fig:nsrkc-pred-100kn).

### Model-based index fits to observations {-}

The model-predicted indices varied in their fits to the survey biomass observations.
...
# Recommended models {-}
For Tanner crab, we recommend a delta-gamma model using a 50-knot mesh as these were consistently top-performing models across sex-maturity categories and periods. However, different best models could be explored by sex-maturity category and fitting period. 
...
df <- smbkc.tab %>%
  select(-X) %>%
  rename("Family" = family, "Estimation method" = estimation, "Knots" = knots, "Log-likelihood" = loglik, "Quantile" = quantile, "Dispersion" = dispersion, "Outliers" = outliers, "Zero inflation" = zero_inf)

tab <- xtable(df, caption = "St. Matthew Island blue king crab fitted model predictive skill (log-likelihood) values, estimated using sdmTMB cross-validation, for models fitted with Tweedie, delta gamma, or delta lognormal model familes; spatial random fields estimated using independent and identically distributed (IID), random walk (RW), or first-order autoregressive (AR1) methods; and spatial resolution of 50, 90, or 120 knots. Predictive skill (log-likelihood) values closer to zero represent better out-of-sample predictive skill. Model configurations with missing log-likelihood values represent models that did not pass sanity checks. DHARMa residual diagnostics are also shown. All models had significant quantile deviations and underdispersion and no significant evidence of outliers. There was evidence of zero inflation for only the IID and RW models with 120 knots.", label = "tab:smbkc.loglik", digits = 0)
...
```{r smbkc-pred-iid-tw-50kn, fig.align = "center", fig.cap = "Heat map of St. Matthew Island blue king crab predicted abundance from the IID Tweedie model with 50 knots."}

knitr::include_graphics(here::here("SMBKC/plots/spatial_pred_iid_tw_50kn.png"))
```

```{r smbkc-pred-iid-tw-90kn, fig.align = "center", fig.cap = "Heat map of St. Matthew Island blue king crab predicted abundance from the IID Tweedie model with 90 knots."}

knitr::include_graphics(here::here("SMBKC/plots/spatial_pred_iid_tw_90kn.png"))
```

```{r smbkc-pred-iid-tw-120kn, fig.align = "center", fig.cap = "Heat map of St. Matthew Island blue king crab predicted abundance from the IID Tweedie model with 120 knots."}

knitr::include_graphics(here::here("SMBKC/plots/spatial_pred_iid_tw_120kn.png"))
```

```{r smbkc-pred-rw-tw-50kn, fig.align = "center", fig.cap = "Heat map of St. Matthew Island blue king crab predicted abundance from the random walk Tweedie model with 50 knots."}

knitr::include_graphics(here::here("SMBKC/plots/spatial_pred_rw_tw_50kn.png"))
```

```{r smbkc-pred-rw-tw-90kn, fig.align = "center", fig.cap = "Heat map of St. Matthew Island blue king crab predicted abundance from the random walk Tweedie model with 90 knots."}

knitr::include_graphics(here::here("SMBKC/plots/spatial_pred_rw_tw_90kn.png"))
```

```{r smbkc-pred-rw-tw-120kn, fig.align = "center", fig.cap = "Heat map of St. Matthew Island blue king crab predicted abundance from the random walk Tweedie model with 120 knots."}

knitr::include_graphics(here::here("SMBKC/plots/spatial_pred_rw_tw_120kn.png"))
```


```{r smbkc-pred-ar1-tw-50kn, fig.align = "center", fig.cap = "Heat map of St. Matthew Island blue king crab predicted abundance from the AR1 Tweedie model with 50 knots."}

knitr::include_graphics(here::here("SMBKC/plots/spatial_pred_ar1_tw_50kn.png"))
```

```{r smbkc-pred-ar1-tw-90kn, fig.align = "center", fig.cap = "Heat map of St. Matthew Island blue king crab predicted abundance from the AR1 Tweedie model with 90 knots."}

knitr::include_graphics(here::here("SMBKC/plots/spatial_pred_ar1_tw_90kn.png"))
```

```{r smbkc-pred-ar1-tw-120kn, fig.align = "center", fig.cap = "Heat map of St. Matthew Island blue king crab predicted abundance from the AR1 Tweedie model with 120 knots."}

knitr::include_graphics(here::here("SMBKC/plots/spatial_pred_ar1_tw_120kn.png"))
```


```{r smbkc-index-iid-tw, fig.align = "center", fig.cap = "Estimated biomass (t) for St. Matthew Island blue king crab. Colored lines represent biomass (±95% CI) estimated using sdmTMB with spatial random fields estimated as independent and identically distributed (IID). Black points represent biomass (±95% CI) estimated by the NMFS EBS bottom trawl survey."}

knitr::include_graphics(here::here("SMBKC/plots/smbkc_iid_tw_fit.png"))
```

```{r smbkc-index-rw-tw, fig.align = "center", fig.cap = "Estimated biomass (t) for St. Matthew Island blue king crab. Colored lines represent biomass (±95% CI) estimated using sdmTMB with spatial random fields estimated using a random walk. Black points represent biomass (±95% CI) estimated by the NMFS EBS bottom trawl survey."}

knitr::include_graphics(here::here("SMBKC/plots/smbkc_rw_tw_fit.png"))
```

```{r smbkc-index-ar1-tw, fig.align = "center", fig.cap = "Estimated biomass (t) for St. Matthew Island blue king crab. Colored lines represent biomass (±95% CI) estimated using sdmTMB with spatial random fields estimated as first-order autoregressive (AR1). Black points represent biomass (±95% CI) estimated by the NMFS EBS bottom trawl survey."}
