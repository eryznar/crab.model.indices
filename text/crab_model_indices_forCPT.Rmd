...
- We also compared model-predicted indices using the best model framework for each stock with indices generated in VAST using a comparable framework to evaluate potential differences in index generation between model algorithms. 
