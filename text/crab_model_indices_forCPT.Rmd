...
```{r spatpred-abund-50-male, fig.align = "center", fig.cap = "Spatial predictions of male abundance using NMFS summer bottom trawl survey data before 1982 and 1982 onward with a 50-knot mesh and a delta-gamma model family. Predictions from both of these periods/models are combined in this figure.", out.width="100%", out.height="100%"}

knitr::include_graphics(here::here("BAIRDI/Figures/EBS_male_spatabund.png"))
```


```{r spatpred-abund-50-imfem, fig.align = "center", fig.cap = "Spatial predictions of immature female abundance using NMFS summer bottom trawl survey data before 1982 and 1982 onward with a 50-knot mesh and a delta-gamma model family. Predictions from both of these periods/models are combined in this figure.", out.width="100%", out.height="100%"}

knitr::include_graphics(here::here("BAIRDI/Figures/EBS_imfem_spatabund.png"))
```

```{r spatpred-abund-50-matfem, fig.align = "center", fig.cap = "Spatial predictions of mature female abundance using NMFS summer bottom trawl survey data before 1982 and 1982 onward with a 50-knot mesh and a delta-gamma model family. Predictions from both of these periods/models are combined in this figure.", out.width="100%", out.height="100%"}

knitr::include_graphics(here::here("BAIRDI/Figures/EBS_matfem_spatabund.png"))
```

```{r spatpred-bio-50-male, fig.align = "center", fig.cap = "Spatial predictions of male biomass using NMFS summer bottom trawl survey data before 1982 and 1982 onward with a 50-knot mesh and a delta-gamma model family. Predictions from both of these periods/models are combined in this figure.", out.width="100%", out.height="100%"}

knitr::include_graphics(here::here("BAIRDI/Figures/EBS_male_spatbio.png"))
```

```{r spatpred-bio-50-imfem, fig.align = "center", fig.cap = "Spatial predictions of immature female biomass using NMFS summer bottom trawl survey data before 1982 and 1982 onward with a 50-knot mesh and a delta-gamma model family. Predictions from both of these periods/models are combined in this figure.", out.width="100%", out.height="100%"}

knitr::include_graphics(here::here("BAIRDI/Figures/EBS_imfem_spatbio.png"))
```

```{r spatpred-bio-50-matfem, fig.align = "center", fig.cap = "Spatial predictions of mature male biomass using NMFS summer bottom trawl survey data before 1982 and 1982 onward with a 50-knot mesh and a delta-gamma model family. Predictions from both of these periods/models are combined in this figure.", out.width="100%", out.height="100%"}
