...
authors: |
  | Emily Ryznar$^{1,2}$, Caitlin Stern$^{3,4}$, and Jon Richar$^{1,5}$
  | $^1$NOAA Fisheries 
  | $^2$emily.ryznar@noaa.gov 
  | $^3$Alaska Department of Fish and Game 
  | $^4$caitlin.stern@alaska.gov 
...
Summary of methods in common among the stocks.
